...
![supervision structure diagram]({{ site.url }}/imgs/supervision_diagram.optimized.webp)
</div>
...
<div class="img-container">
![supervision structure diagram]({{ site.url }}/imgs/supervision_diagram_dynamic.optimized.webp)
</div>
