...
![single genserver contention]({{ site.url }}/imgs/single_genserver_contention.optimized.webp)
</div>
...
<div class="img-container">
![single genserver contention]({{ site.url }}/imgs/genserver_pool.optimized.webp)
</div>
