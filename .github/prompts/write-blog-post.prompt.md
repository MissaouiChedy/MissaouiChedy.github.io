...
argument-hint: "blog post file, code sample folder"
agent: "agent"
---
...
Elaborate on the blog post file {{ blog_post_file_path }} containing an outline. Elaborate on the content based on the outline in the same file.
